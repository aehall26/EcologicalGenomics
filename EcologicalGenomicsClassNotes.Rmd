...
---
title: "Ecological Genomic Notes"
editor_options: null
output:
...
# Table of Contents:  
  * [Entry 1: 2020-01-13, Monday](#id-section1)
    ...
    * [Entry 8: 2020-01-22, Wednesday](#Setting up github repo)
...
class server is a unix server called pbio381.uvm.edu
notes are provided for the tutorial online
regions are both genetic regions as well as geographic 
grep- only find a match if it matches the entire cell completely 
original file is not changed by grep
you have to save these results seperately 
------
<div id='id-section17'/>   
